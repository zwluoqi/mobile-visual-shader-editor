...
vec3 lightRadiance = uLightRadiance.xyz;
 vec4 gradient_tex1_color_0;
 float gradient_tex1_fac_1;
 node_tex_gradient_linear(VERTEX_CD_ORCO,gradient_tex1_color_0,gradient_tex1_fac_1);
 vec4 emission0_emission_0=emission0_strength_2*vec4(lightRadiance,1.0)*gradient_tex1_color_0;
