...
uniform float magic_tex5_depth_2;
uniform float magic_tex5_scale_4;
uniform float magic_tex5_distortion_5;
...
vec3 lightRadiance = uLightRadiance.xyz;
 vec4 magic_tex5_color_0;
 float magic_tex5_fac_1;
 node_tex_magic(magic_tex5_depth_2,VERTEX_CD_ORCO,magic_tex5_scale_4,magic_tex5_distortion_5,magic_tex5_color_0,magic_tex5_fac_1);
 vec4 emission0_emission_0=emission0_strength_2*vec4(lightRadiance,1.0)*magic_tex5_color_0;
