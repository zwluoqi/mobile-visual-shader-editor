...
uniform float noise_tex1_w_4;
uniform float noise_tex1_scale_5;
uniform float noise_tex1_detail_6;
uniform float noise_tex1_roughness_7;
uniform float noise_tex1_distortion_8;
...
vec3 lightRadiance = uLightRadiance.xyz;
 float noise_tex1_fac_0;
 vec4 noise_tex1_color_1;
 node_noise_texture_3d(VERTEX_CD_ORCO,noise_tex1_w_4,noise_tex1_scale_5,noise_tex1_detail_6,noise_tex1_roughness_7,noise_tex1_distortion_8,noise_tex1_fac_0,noise_tex1_color_1);
 vec4 emission0_emission_0=emission0_strength_2*vec4(lightRadiance,1.0)*noise_tex1_color_1;
