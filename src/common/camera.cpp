...
struct Camera
{
	...
	void update(float _deltaTime, const entry::MouseState& _mouseState, bool _reset)
	{
		...
		if (!m_mouseDown && !m_leftmouseDown)
		{
			m_mouseLast.m_mx = _mouseState.m_mx;
			m_mouseLast.m_my = _mouseState.m_my;
		}
        ...
        m_leftmouseDown = !!_mouseState.m_buttons[entry::MouseButton::Left];
...
//            if(m_leftmouseDown){
//                if(deltaX>0){
//                    m_keys |=CAMERA_KEY_RIGHT;
//                }else{
//                    m_keys |=CAMERA_KEY_LEFT;
//                }
//                if(deltaY>0){
//                    m_keys |=CAMERA_KEY_FORWARD;
//                }else{
//                    m_keys |=CAMERA_KEY_BACKWARD;
//                }
//            }
		}
